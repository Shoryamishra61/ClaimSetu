...
$Segments = @(
    ...
    "ClaimSetu checks one documented prerequisite using fictional records. It finds that the previous employment has no Date of Exit.",
    ...
    "The prerequisite is now met in the simulation. ClaimSetu points to EPFO's Mark Exit route before Ravi retries the transfer.",
    ...
    "ClaimSetu removes one hidden prerequisite, without pretending to be EPFO."
)
