...
| The live project form extends the deadline to 29 Aug 2026, 10:00 PM IST; video is at most two minutes; summary is under 250 words. The public brief still displays the earlier date. | [Official submission form](https://forms.gle/FVJNG9JqfRuUrhp76), [Builder Brief](https://buildwhatmovesindia.com/brief) | PRIMARY-OFFICIAL | 2026-08-29 | HIGH | No | Yes |
