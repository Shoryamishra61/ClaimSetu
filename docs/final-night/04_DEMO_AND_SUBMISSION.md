...
The app accepts no Aadhaar, PAN, UAN, OTP, password or document upload. Its core runs deterministically without an LLM and has a generated static fallback for the public demo. English/Hindi switching, keyboard navigation, 320 px reflow, undo, error handling and source disclosure are implemented.
