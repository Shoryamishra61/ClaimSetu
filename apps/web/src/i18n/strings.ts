...
export const UI = {
  ...
  "finding.epfo.history.block_title": {
    en: "The missing exit date blocks this transfer",
    hi: "service-history की तारीख यह काम रोकती है",
  },
  "finding.epfo.history.block": {
    en: "EPFO requires Date of Exit for the previous employment before an online transfer; this fictional record has none.",
    hi: "EPFO ऑनलाइन ट्रांसफर से पहले पिछली नौकरी की exit date माँगता है; इस काल्पनिक रिकॉर्ड में यह नहीं है।",
  },
  ...
  "finding.epfo.history.pass": {
    en: "The fictional previous employment now has a Date of Exit, satisfying this documented transfer prerequisite.",
    hi: "काल्पनिक पिछली नौकरी में अब exit date दर्ज है, इसलिए यह आधिकारिक ट्रांसफर शर्त पूरी होती है।",
  },
  "finding.epfo.history.uncertainty": {
    en: "The requirement and route come from EPFO; the record values and successful recheck are simulated.",
    hi: "शर्त और प्रक्रिया EPFO से हैं; रिकॉर्ड मान और सफल दोबारा जाँच काल्पनिक हैं।",
  },
  ...
  "action.b1.title": {
    en: "Add the fictional Date of Exit",
    hi: "काल्पनिक service-history तारीख सुधारें",
  },
  "action.b1.effect": {
    en: "Satisfies the documented prerequisite for an online PF transfer in this simulation.",
  ...
  "handoff.epfo.step1": {
    en: "Confirm that two months have passed since the previous job's last contribution.",
    hi: "पुष्टि करें कि पिछली नौकरी के अंतिम योगदान के बाद दो महीने बीत चुके हैं।",
  },
  "handoff.epfo.step2": {
    en: "In the Member Portal, use Manage → Mark Exit and enter the real exit date and reason from your records.",
    hi: "Member Portal में Manage → Mark Exit खोलें और अपने रिकॉर्ड से सही exit date व कारण भरें।",
  },
  "handoff.epfo.step3": {
    en: "Retry the online transfer only after the official service history shows the update.",
    hi: "आधिकारिक service history में बदलाव दिखने के बाद ही ऑनलाइन ट्रांसफर दोबारा करें।",
  },
  "handoff.life.title": {
    en: "What you would do next",
    hi: "अब आगे क्या करें",
  ...
  "claimpath.tagline": { en: "EPFO transfer pre-flight", hi: "EPFO ट्रांसफर प्री-फ्लाइट" },
  ...
  "claimpath.hero": { en: "Ravi cannot move his old PF balance.", hi: "रवि अपना पुराना PF बैलेंस ट्रांसफर नहीं कर पा रहा।" },
  "claimpath.heroBody": {
    en: "His previous account is missing from the transfer list. One visible name difference looks suspicious—but it is not what stops this fictional case.",
    hi: "पिछला खाता ट्रांसफर सूची में नहीं दिखता। नाम का एक अंतर संदिग्ध लगता है—लेकिन इस काल्पनिक केस को वह नहीं रोकता।",
  },
  ...
  "claimpath.noteHelp": {
    en: "No UAN, Aadhaar, PAN, OTP or document details are requested.",
    hi: "UAN, Aadhaar, PAN, OTP या दस्तावेज़ विवरण नहीं माँगे जाते।",
  },
  "claimpath.browserNote": {
    en: "No UAN, Aadhaar, PAN, OTP or real account record is needed.",
    hi: "किसी UAN, Aadhaar, PAN, OTP या वास्तविक खाते के रिकॉर्ड की जरूरत नहीं है।",
  },
  ...
  "claimpath.findBlocker": { en: "Find what blocks the transfer", hi: "ट्रांसफर की रुकावट खोजें" },
  "claimpath.currentPortal": { en: "What Ravi sees in the current journey", hi: "मौजूदा प्रक्रिया में रवि क्या देखता है" },
  "claimpath.currentFailure": { en: "Previous PF account not available to transfer", hi: "पिछला PF खाता ट्रांसफर के लिए उपलब्ध नहीं" },
  "claimpath.currentFailureHelp": { en: "The screen does not bring the missing prerequisite and the safe next action together.", hi: "स्क्रीन छूटी हुई शर्त और सुरक्षित अगला कदम एक साथ नहीं बताती।" },
  ...
  "claimpath.causeNote": { en: " We test the documented record prerequisite that actually stops the fictional transfer.", hi: " हम उस आधिकारिक रिकॉर्ड शर्त को जाँचते हैं जो काल्पनिक ट्रांसफर रोकती है।" },
  ...
  "claimpath.diagnosisBody": { en: "EPFO says the previous employment needs a Date of Exit before an online transfer. Ravi’s fictional service history has none.", hi: "EPFO के अनुसार ऑनलाइन ट्रांसफर से पहले पिछली नौकरी की exit date जरूरी है। रवि के काल्पनिक service history में यह नहीं है।" },
  ...
  "claimpath.exitMissingBody": { en: "Without it, Ravi’s previous employment cannot pass the documented prerequisite for this online transfer.", hi: "इसके बिना रवि की पिछली नौकरी इस ऑनलाइन ट्रांसफर की आधिकारिक शर्त पूरी नहीं करती।" },
  ...
  "claimpath.evidenceLimit": { en: "EPFO documents this prerequisite. ClaimPath uses fictional records and cannot confirm a real member's eligibility.", hi: "EPFO इस शर्त को प्रकाशित करता है। ClaimPath काल्पनिक रिकॉर्ड उपयोग करता है और किसी वास्तविक सदस्य की पात्रता तय नहीं कर सकता।" },
  ...
  "claimpath.resultTitle": { en: "The transfer prerequisite is now met.", hi: "ट्रांसफर की शर्त अब पूरी है।" },
  "claimpath.resultBody": { en: "The documented transfer prerequisite now passes in this fictional case. This does not submit or approve a real transfer.", hi: "इस काल्पनिक केस में आधिकारिक ट्रांसफर शर्त अब पूरी है। इससे कोई वास्तविक ट्रांसफर जमा या मंजूर नहीं होता।" },
  "claimpath.minimumFix": { en: "The minimum correction tested", hi: "जाँचा गया न्यूनतम सुधार" },
  "claimpath.minimumFixBody": { en: "Only the fictional Date of Exit was added; the visible name variation was left alone.", hi: "केवल काल्पनिक exit date जोड़ी गई; दिखने वाला नाम अंतर बिना बदलाव छोड़ा गया।" },
  ...
  "claimpath.handoffTitle": { en: "Mark Exit in the official EPFO portal", hi: "आधिकारिक EPFO पोर्टल में Mark Exit करें" },
  ...
  "claimpath.privacyBody": { en: "ClaimPath uses one bundled fictional worker profile. The judged journey has no text box, upload, login or identifier field, so the prototype demonstrates the prerequisite without citizen data.", hi: "ClaimPath एक पहले से तैयार काल्पनिक कर्मचारी प्रोफ़ाइल उपयोग करता है। निर्णायक यात्रा में टेक्स्ट बॉक्स, अपलोड, लॉगिन या पहचान संख्या फ़ील्ड नहीं है, इसलिए यह प्रोटोटाइप नागरिक डेटा लिए बिना शर्त दिखाता है।" },
  "privacy.title": {
