...
class IdentityRescueEngine:
    ...
    def _evaluate_ravi(
        ...
        attempt_date = str(_field(epfo, "claim_attempt_date") or "")
        service_history_passes = bool(exit_date and attempt_date and exit_date <= attempt_date)
        service_history = Finding(
            ...
            inputs=[
                ...
                _input(epfo, "claim_attempt_date", "Fictional claim attempt date"),
            ],
            source_ids=["SRC-EPFO-001"],
